...
## 아키텍처 개요
graph TD
    User["사용자<br>(브라우저: 지도, 검색창, 공지패널)"]
    Front["Frontend<br>(Next.js / React / Leaflet)"]
    API["Backend API Routes<br>(Node.js / Express / Next.js)"]
    Data["Mock & Real Data<br>(CSV, JSON, GeoJSON in /data)"]
    External["External APIs<br>(Kakao Local API / 서울시 RSS)"]
